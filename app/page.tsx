 ...
 return (<div className="min-h-screen bg-gradient-to-b from-slate-50 to-white text-slate-900">
  ...
  <section id="pricing" className="max-w-6xl mx-auto px-4 py-10"><h2 className="text-2xl font-bold mb-6">Simple pricing</h2>
   <div className="grid md:grid-cols-3 gap-5">
    <PriceCard title="Donor Intel" price="$995/mo" features={["RFA scoring & segments","Weekly grant alerts","Dashboard view","Email templates"]}/>
    <PriceCard title="Campaign Co‑Pilot" price="$2,250/mo" features={["Everything in Intel","3‑touch sequences","Grant paragraphs","Board‑ready reports"]} highlighted/>
    <PriceCard title="Full Service" price="$4,500/mo" features={["Everything in Co‑Pilot","Grant drafting","Quarterly strategy","Custom CRM workflows"]}/>
   </div></section>
  <section id="contact" className="max-w-6xl mx-auto px-4 py-12"><div className="grid md:grid-cols-2 gap-8 items-start">
   <div><h2 className="text-2xl font-bold">Book a pilot</h2><p className="text-slate-600 mt-2">Tell us about your organization. We’ll set up a 30‑minute working session and share a customized demo using your public data.</p>
